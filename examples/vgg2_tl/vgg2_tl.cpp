...
#include "vgg_layer.h"
	...
	extern "C" 
 void vgg0(const ap_uint<IFMAP_DW> fmap[REP * DIM_LAYER0*DIM_LAYER0*CH_LAYER0],  hls::stream<ap_uint<FMAP_DW> >& max_pool3, const int rep){
...
void vgg_0(const ap_uint<IFMAP_DW> fmap[REP * DIM_LAYER0*DIM_LAYER0*CH_LAYER0],
 const int rep,
hls::stream<ap_uint<128> >& resp_head, hls::stream<ap_uint<65> >& resp_data,
hls::stream<ap_uint<128> >& req_head, hls::stream<ap_uint<65> >& req_data, ap_uint<64>srcmac, ap_uint<64>dstmac
){
#pragma HLS INTERFACE s_axilite port=rep bundle=control
#pragma HLS INTERFACE s_axilite port=return bundle=control
...
#pragma HLS DATAFLOW
    ...
    vgg0(fmap, max_pool3, rep);
    send_to_network<DIM_LAYER3, CH_LAYER3, 2, ap_uint<FMAP_DW> >(max_pool3, rep, resp_head, resp_data, srcmac, dstmac);
}

void vgg_1(ap_uint<OUT_DW> out[REP * FC_LAYER2*FMAP_DW/OUT_DW],
 const int rep,
hls::stream<ap_uint<128> >& resp_head, hls::stream<ap_uint<65> >& resp_data,
hls::stream<ap_uint<128> >& req_head, hls::stream<ap_uint<65> >& req_data, ap_uint<64>srcmac, ap_uint<64>dstmac
){
...
#pragma HLS DATAFLOW
    hls::stream<ap_uint<FMAP_DW> > max_pool3_in;
    recv_from_nework<DIM_LAYER4, CH_LAYER3, ap_uint<FMAP_DW> >(max_pool3_in, rep, req_head, req_data, srcmac, dstmac);
    vgg1(max_pool3_in, out, rep);
}

void vgg(const ap_uint<IFMAP_DW> fmap[REP * DIM_LAYER0*DIM_LAYER0*CH_LAYER0], ap_uint<OUT_DW> out[REP * FC_LAYER2*FMAP_DW/OUT_DW],
 const int rep,
hls::stream<ap_uint<128> >& resp_head, hls::stream<ap_uint<65> >& resp_data,
hls::stream<ap_uint<128> >& req_head, hls::stream<ap_uint<65> >& req_data, ap_uint<64>srcmac, ap_uint<64>dstmac
){
...
#pragma HLS DATAFLOW
    ...
    hls::stream<ap_uint<FMAP_DW> > max_pool3_in;
    #pragma HLS STREAM variable=max_pool3_in depth=256
