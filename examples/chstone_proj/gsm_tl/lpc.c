...
void
lpc(word * s /* 0..159 signals       IN/OUT  */ ,
		  word * LARc /* 0..7   LARc's        OUT     */ )
{
#pragma HLS INTERFACE m_axi port=s offset=slave bundle=gmem0 // Direct is for AXI with full 32 bit address space
#pragma HLS INTERFACE m_axi port=LARc offset=slave bundle=gmem0 // Slave is for AXI4Lite, with burst mode disabled

#pragma HLS INTERFACE s_axilite port=s bundle=control
#pragma HLS INTERFACE s_axilite port=LARc bundle=control
