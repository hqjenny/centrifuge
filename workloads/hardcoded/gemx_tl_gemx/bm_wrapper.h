...
void gemx_accel_wrapper(uint64_t p_aAddr_m_Val, uint64_t p_bAddr_m_Val, uint64_t p_cAddr_m_Val, uint64_t p_xAddr_m_Val, uint32_t p_aColBlocks, uint32_t p_aRowBlocks, uint32_t p_bColBlocks, uint32_t p_aLd, uint32_t p_bLd, uint32_t p_cLd, uint32_t p_xLd, uint32_t p_transpBlocks, uint32_t p_postScale) {
    // Disable Interrupt
